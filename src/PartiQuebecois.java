...
public class PartiQuebecois {
	...
	PartiQuebecois(Scanner scanner) {
	...
	public void run() {
		/*
		 * numberOfVoters: Array of voters that stores the details of voters , entered
		 * by user
		 */
		...
		/*
		 * numberOfVoters: Maximum no of voters that can be stored,requested by the
		 * application user
		 */
		numberOfVoters = Integer.parseInt(scanner.nextLine().trim());
		voterBase = new Voter[numberOfVoters];
